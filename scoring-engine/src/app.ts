...
export const DIFFICULTY_BONUS: Record<'easy' | 'medium' | 'hard', number> = {
  easy: 50,
  medium: 75,
  hard: 120,
};

export function isScoreRequest(value: unknown): value is ScoreRequest {
...
export function compareAnswers(expected: string, actual: string): boolean {
